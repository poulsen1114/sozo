    ...
    if (targetId && (window.location.pathname.endsWith('/') || window.location.pathname.endsWith('index.html'))) {
        ...
        const checkHeaderLoaded = setInterval(() => {
            ...
            if (headerElement) {
                ...
                console.log(`Waiting ${1500}ms before scrolling...`); // Debug log
                setTimeout(() => {
                ...
                }, 1500); // <--- Adjust this delay (e.g., 100, 150, 250ms) if needed
